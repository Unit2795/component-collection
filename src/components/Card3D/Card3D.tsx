...
/**
 * Card component with a 3D hover effect
 * - Uses perspective and rotation to create a 3D effect when moving mouse over and around the card
 * - Uses a radial gradient that follows the mouse to create a shine effect
 * */
const Card3D = ( {
	children
}: {
	...
	return (
		<div
			...
			<div
				className={
					clsx(
						"bg-white/[.01] rounded-2xl shadow-xl p-6 backdrop-blur-sm relative overflow-hidden transform transition-transform duration-0"
					)
				}
				style={
					{
